...
},
{
  ...
  return (
    <div className="bg-[url(/Section-4-Background.png)] font-urbitsan   pt-[100px]  pr-[24px] pb-[100px] pl-[24px] gap-[32px]   bg-cover  flex justify-center items-center flex-wrap border-b border-slate-400">
    {
    data.map((elm,i=0)=>(
